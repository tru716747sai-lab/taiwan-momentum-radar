...
def score_ignition(df):
    ...
    # =========================================================
    # Early-stage chase penalty v2.2
    #
    # Hard Gate 負責排除已經太晚的股票。
    #
    # Penalty 只負責：
    # 在仍符合 Ignition 的股票中，
    # 對已經接近漲幅上限者降低排序。
    ...
    # =========================================================
    # IGNITION v2.2 — Early Warning Hard Signals
    # =========================================================
    ...
    #
    # 注意：
    # 這是 cross-sectional / ranking signal，
    # 不是實際「加速度百分比」。
    # ---------------------------------------------------------
    ...
    # =========================================================
    # FINAL IGNITION QUALIFICATION v2.2
    #
    # 必須同時：
    #
    # A. -5% <= 5日報酬 < +20%
    # B. 20日 < +35%、60日 < +70%
    # C. 最近5日平均量 >= 前20日平均量 1.5倍
    # D. 不得高於前60日高點 +10%以上
    # E. 接近前60日高點 OR 短期動能轉強
    #
    # 不要求已經突破。
    # =========================================================
